...
import { TextField, PrimaryButton, DetailsList,DetailsListLayoutMode, IDropdownStyles,ITextFieldStyles,
  SelectionMode, 
  IDropdown,
  Dropdown,
  IDropdownOption,
  CheckboxVisibility,
Selection} from 'office-ui-fabric-react';
    ...
    return (
      <div className={styles.reactcruddemo}>
       ...
       <p >
        ...
        <PrimaryButton text='Update' title='Update'  onClick={this.btnAdd_click} />
        <PrimaryButton text='Delete' title='Delete'  onClick={this.btnAdd_click} />
        </p>
