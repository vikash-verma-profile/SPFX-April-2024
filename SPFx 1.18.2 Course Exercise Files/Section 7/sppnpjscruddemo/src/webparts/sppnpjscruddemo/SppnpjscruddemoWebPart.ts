...
export default class SppnpjscruddemoWebPart extends BaseClientSideWebPart <ISppnpjscruddemoWebPartProps> {
  ...
  private deleteListItem(): void {
    ...
    pnp.sp.web.lists.getByTitle("SoftwareCatalog").items.getById(parseInt(id)).delete();
  ...
  private updateListItem(): void {
    ...
    pnp.sp.web.lists.getByTitle("SoftwareCatalog").items.getById(parseInt(id)).update({
      Title: title,
  ...
  private readListItem(): void {
    ...
    pnp.sp.web.lists.getByTitle("SoftwareCatalog").items.getById(parseInt(id)).get().then((item: any) => {
      (document.getElementById("txtSoftwareTitle")as HTMLInputElement)!["value"] = item["Title"];
      (document.getElementById("txtSoftwareName")as HTMLInputElement)!["value"] = item["SoftwareName"];
      (document.getElementById("txtSoftwareVersion")as HTMLInputElement)!["value"] = item["SoftwareVersion"];
      (document.getElementById("txtSoftwareDescription")as HTMLInputElement)!["value"] = item["SoftwareDescription"];      
      (document.getElementById("ddlSoftwareVendor")as HTMLInputElement)!["value"] = item["SoftwareVendor"];
